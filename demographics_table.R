...
df_old_dwi <- left_join(df_old_dwi, vols)
...
df_old_dwi$`left hippocampus` <- df_old_dwi$`left hippocampus` * 1000
df_old_dwi$`right hippocampus` <- df_old_dwi$`right hippocampus` * 1000
